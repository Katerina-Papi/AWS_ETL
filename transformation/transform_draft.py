...
data2 = data.iloc[:, [8,7,1,3,4,5]] #without the name column (2)
...
print('------------------------------------------------------------')
print(len(data2))
print(data2.iloc[0,3]) #row 0, column 3 (order and cost)
print('---------------------------------------------==============')
for i1 in range(len(data2)):
    ...
    #print(type(d))
    d = str(d) 
    #data2.iloc[i1,3] = d   # column list of dictionaries converted to string as pandas does not accept lists in cells
    #print(data2.iloc[i1,3]) 
    #print(type(data2.iloc[i1,3]))
print(data2)        
